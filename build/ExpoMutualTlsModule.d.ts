...
import { ExpoMutualTlsModuleEvents, MutualTlsConfig, StoreCertificateOptions, MakeRequestOptions, MakeRequestResult, ConfigureResult, CertificateData, ParseCertificateResult, WebSocketOptions, WebSocketConnectionResult } from "./ExpoMutualTls.types";
declare class ExpoMutualTlsModule extends NativeModule<ExpoMutualTlsModuleEvents> {
    ...
    parseCertificate(certificateData: CertificateData): Promise<ParseCertificateResult>;
...
declare const _default: ExpoMutualTlsModule;
export default _default;
//# sourceMappingURL=ExpoMutualTlsModule.d.ts.map